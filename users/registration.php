...
<head>
	...
	<title>Lapor PDAM | User Registration</title>
...
<body>
	<div id="login-page">
		<div class="container">
			<h3 align="center" style="color:#fff">Selamat Datang Lapor PDAM</h3>
			<hr />
			<form class="form-login" method="post">
				...
				<div class="login-wrap">
					<input type="text" class="form-control" placeholder="Nama Lengkap" name="fullname" required="required" autofocus>
					<br>
					...
					<input type="text" class="form-control" maxlength="10" name="contactno" placeholder="Nomor HP" required="required" autofocus>
					<br>
