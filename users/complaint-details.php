         ...
         while($row=mysqli_fetch_array($query))
          {?>
            ...
            <div class="row mt">
              ...
              <div class="col-sm-4">
                <p><?php echo htmlentities($row['nama']);?></p>
              </div>
              <label class="col-sm-2 col-sm-2 control-label"><b>alamat :</b> </label>
              <div class="col-sm-4">
                <p><?php echo htmlentities($row['alamat']);?></p>
              </div>
              <label class="col-sm-2 col-sm-2 control-label"><b>No. SR :</b> </label>
              <div class="col-sm-4">
                <p><?php echo htmlentities($row['nosr']);?></p>
              </div>
